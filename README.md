...
- **18 approved mutations** of the master prompt (v1.0 → v2.9) in ~8 weeks, each grounded in real executions — [full dated history, sanitized →](docs/CHANGELOG-HISTORY.md)
