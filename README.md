...
- **27 approved mutations** of the master prompt (v1.0 → v3.8) in ~13 weeks, each grounded in real executions — [full dated history, sanitized →](docs/CHANGELOG-HISTORY.md)
