...
- **19 mutaciones aprobadas** del prompt maestro (v1.0 → v3.0) en ~8 semanas, cada una fundada en ejecuciones reales — [historial completo fechado, sanitizado →](docs/CHANGELOG-HISTORY.md) (en inglés)
