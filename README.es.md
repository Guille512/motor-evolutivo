...
- **30 mutaciones aprobadas** del prompt maestro (v1.0 → v3.11) en ~15 semanas, cada una fundada en ejecuciones reales — [historial completo fechado, sanitizado →](docs/CHANGELOG-HISTORY.md) (en inglés)
